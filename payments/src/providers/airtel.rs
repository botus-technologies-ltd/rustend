...
pub struct AirtelConfig {
    ...
    pub environment: AirtelEnvironment,
}
#[derive(Debug, Clone, Copy)]
pub enum AirtelEnvironment {
    Sandbox,
    Production,
}
...
impl AirtelConfig {
    pub fn new(
        ...
        Self {
            ...
            environment: AirtelEnvironment::Sandbox,
        }
    }
    pub fn production(mut self) -> Self {
        self.environment = AirtelEnvironment::Production;
        self
    }
}
...
impl PaymentGateway for AirtelGateway {
    ...
    async fn create_payment(
        ...
        let mut intent = PaymentIntent::new(PaymentProvider::AirtelMoney, amount);
    ...
    async fn create_customer(&self, _customer: Customer) -> PaymentResult<String> {
        Ok(format!("AIRTEL_CUS_{}", uuid::Uuid::new_v4()))
    }
    ...
    async fn attach_payment_method(
        ...
        Ok(format!("AIRTEL_PM_{}", uuid::Uuid::new_v4()))
    }
    ...
    async fn update_subscription(
        ...
        Ok(Subscription::new(
            ...
            "customer_123",
            &SubscriptionPlan::new("default", Amount::new(1000, "KES"), BillingInterval::Month),
        ))
    }
    ...
    async fn create_batch_payout(&self, payouts: Vec<Payout>) -> PaymentResult<BatchPayout> {
        Ok(BatchPayout::new(PaymentProvider::AirtelMoney, payouts))
    }
    ...
    async fn get_balance(&self, account_id: &str) -> PaymentResult<WalletBalance> {
        Ok(WalletBalance {
            ...
            available: Amount::new(300000, "KES"),
            pending: Amount::new(30000, "KES"),
