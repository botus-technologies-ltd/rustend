...
impl PayPalConfig {
    ...
    pub fn production(mut self) -> Self {
        self.environment = PayPalEnvironment::Production;
        self
    }
}
...
impl PaymentGateway for PayPalGateway {
    ...
    async fn create_customer(&self, _customer: Customer) -> PaymentResult<String> {
        Ok(format!("PAYPAL_CUS_{}", uuid::Uuid::new_v4()))
    }
    ...
    async fn attach_payment_method(
        ...
        Ok(format!("PAYPAL_PM_{}", uuid::Uuid::new_v4()))
    }
    ...
    async fn create_batch_payout(&self, payouts: Vec<Payout>) -> PaymentResult<BatchPayout> {
        Ok(BatchPayout::new(PaymentProvider::PayPal, payouts))
    }
    ...
    async fn get_balance(&self, account_id: &str) -> PaymentResult<WalletBalance> {
        Ok(WalletBalance {
            ...
            available: Amount::new(50000, "USD"),
            pending: Amount::new(5000, "USD"),
